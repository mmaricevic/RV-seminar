...
\begin{frame}{Izrada postera}
    \begin{itemize}
     ...
     \end{itemize}
      \begin{figure}
 			\includegraphics[width=0.3\textwidth,height=0.4\textheight]{picture13.jpg}
...
\begin{frame}{Tikzposter i Beamerposter}
 ...
 \begin{frame}{Primjeri tema}
 	      \begin{figure}
 			\includegraphics[width=0.5\textwidth,height=0.6\textheight]{picture15.png}
...
\end{frame}
 ...
 \begin{frame}{Primjer Beamerpostera}
      \begin{figure}
 			\includegraphics[width=0.5\textwidth,height=0.7\textheight]{picture14.jpg}
...
\bibitem{lit1} \url{https://www.sharelatex.com/learn/Beamer}
\bibitem{lit2} 	\url{https://www.sharelatex.com/learn/Powerdot}
\bibitem{lit3} \url{https://www.sharelatex.com/learn/Posters}
\bibitem{lit4} \url{https://en.wikibooks.org/wiki/LaTeX/Presentations}
\bibitem{lit5} \url{http://www1.uwindsor.ca/math/sites/uwindsor.ca.math/files/08-02.pdf}
\end{thebibliography}
\end{frame}
